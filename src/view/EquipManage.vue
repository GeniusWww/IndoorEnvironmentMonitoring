<template>
  ...
  <el-table ref="multipleTable"
    ...
    <el-table-column label="场所编号" prop="device_id.grid_id.grid_id">
    </el-table-column>
    <el-table-column label="位置" prop="device_id.grid_id.grid_address">
    </el-table-column>
      <el-table-column label="TVOC阈值(mg/立方米)" prop="device_AQIt">
    </el-table-column>
     <el-table-column label="CO阈值(mg/立方米)" prop="device_pm25t">
    </el-table-column>
...
<div class="block1" style="margin-left:0;">
  ...
  <el-form :model="form">
    ...
    <el-form-item label="TVOC阈值" :label-width="formLabelWidth">
      <el-input v-model="form.device_AQIt" placeholder="请输入TVOC阈值"></el-input>
    </el-form-item>
    <el-form-item label="CO阈值" :label-width="formLabelWidth">
      <el-input v-model="form.device_pm25t" placeholder="请输入CO阈值"></el-input>
    </el-form-item>
    ...
    <el-form-item label="场所编号" :label-width="formLabelWidth">
      <el-input v-model="form.device_id.grid_id" placeholder="请输入场所编号" :disabled="formForbid"> </el-input>
    </el-form-item>
  </el-form>
