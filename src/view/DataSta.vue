    ...
    <div class="div1">
      ...
      >
        ...
        <el-table-column prop="device_id" label="设备编号" width="100">
         ...
         <el-table-column prop="device_time" label="时间" width="100">
        </el-table-column>
    ...
    <el-form :inline="true" :model="formInline" class="demo-form-inline">
      ...
      <el-form-item label="">
        <el-select v-model="formInline.type" placeholder="选择参数类型">
          <el-option label="TVOC" value="devdata_AQI"></el-option>
      ...
      <el-form-item>
        ...
        <!-- <el-button type="primary" v-show="drawEchart1">查询</el-button> -->
      </el-form-item>
    </el-form>
  </div>
</template>
    ...
    drawEchart1() {
      ...
      myChart.on("click", function(params) {
        ...
        myChart.dispatchAction({
          ...
          endValue:
            that.edata1[
              Math.min(params.dataIndex + zoomSize / 2, that.edata2.length - 1)
            ]
        });
      });
