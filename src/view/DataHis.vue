<template>
  ...
  <el-form-item label="">
    <el-select v-model="formInline.type" placeholder="选择参数类型">
      <el-option label="TVOC" value="devicehis_AQI"></el-option>
  ...
  methods: {
    ...
    onSubmit() {
         var lab4 = [{
          ...
          devicehis_checktime: "2022-06-02 14:00:00",
          devicehis_O3: 22
        },
        {
          date: "2022-06-03 14:00:00",
          devicehis_checktime: "2022-06-03 14:00:00",
          devicehis_O3: 24
        },
        {
          date: "2022-06-04 14:00:00",
          devicehis_checktime: "2022-06-04 14:00:00",
          devicehis_O3: 25
        },
        {
          date: "2022-06-05 14:00:00",
          devicehis_checktime: "2022-06-05 14:00:00",
          devicehis_O3: 26
        },
        {
          date: "2022-06-06 14:00:00",
          devicehis_checktime: "2022-06-06 14:00:00",
          devicehis_O3: 25
        },
        {
          date: "2022-06-07 14:00:00",
          devicehis_checktime: "2022-06-07 14:00:00",
          devicehis_O3: 27
        },
        {
          date: "2022-06-08 14:00:00",
          devicehis_checktime: "2022-06-08 14:00:00",
          devicehis_O3: 23
        },
        {
          date: "2022-06-09 14:00:00",
          devicehis_checktime: "2022-06-09 14:00:00",
          devicehis_O3: 26
        },
        {
          date: "2022-06-16 14:00:00",
          devicehis_checktime: "2022-06-16 14:00:00",
          devicehis_O3: 26
        },
        {
          date: "2022-06-17 14:00:00",
          devicehis_checktime: "2022-06-17 14:00:00",
          devicehis_O3: 23
        },
        {
          date: "2022-06-18 14:00:00",
          devicehis_checktime: "2022-06-18 14:00:00",
          devicehis_O3: 24
        },
        {
          date: "2022-06-19 14:00:00",
          devicehis_checktime: "2022-06-19 14:00:00",
          devicehis_O3: 21
        }];
      this.tableData = lab4
      ...
      for (var i = 0; i < this.tableData.length; i++) {
        if (this.Value1[0] <= this.tableData[i].date) {
          if (this.Value1[1] >= this.tableData[i].date) {
            this.echartTableData.push(this.tableData[i]);
          }
        }
      } //console.log("截取数值:",this.Value1);
      //console.log("这是类型",this.formInline.type);
      //console.log("这是设备号",this.formInline.number);
      console.log(this.echartTableData);

      var lab1 = [];
      var lab2 = [];
      for (var i = 0; i < this.echartTableData.length; i++) {
        lab1.push(this.echartTableData[i].devicehis_checktime);
        lab2.push(this.echartTableData[i].devicehis_O3);
      }
