<template>
  <div id="Home">
    <!-- 页面头部 -->
    <div class="header">
    	<div class="leftitle">室内环境监测平台 </div> 
      <!-- <img src="../assets/gonggongyunfuwu.png" alt="云" width="38" height="28"></img> -->
    		...
    		<div class="leftnav">
    			 <el-menu
			      ...
			      <el-menu-item index="/GridManage" @click='GridCli'>
			        <span class="iconfont icon-wangge"> 场所信息管理</span>
			      </el-menu-item>
             ...
             <el-menu-item index="/LargeScreen" @click='LargeCli'>
              <span class="iconfont icon-daping">      驾驶舱</span>
            </el-menu-item>
